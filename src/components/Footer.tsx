...
export default function Footer() {
  return (
    <footer id="contacts" className="relative w-full bg-[#FFC107] dark:bg-[#C9950A] text-[#FFFFFF] dark:text-[#F0F0F0] dark:text-[#F0F0F0] pt-8 pb-12 z-20">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full flex flex-col md:grid md:grid-cols-3 md:justify-items-center gap-8 md:gap-10 mt-2">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left mb-6 md:mb-0 md:max-w-[280px]">
          <h2 className="text-6xl font-black text-[#FFFFFF] dark:text-[#F0F0F0] tracking-tighter mb-4 md:mb-6 drop-shadow-sm">HardClean</h2>
          <p className="text-[#FFFFFF] dark:text-[#F0F0F0]/80 text-lg leading-relaxed font-medium">
        ...
        <div className="flex flex-row justify-between w-full text-left md:contents">
          ...
          <div className="flex flex-col items-start w-[48%] md:w-full md:max-w-[280px]">
            ...
            <p className="text-[#FFFFFF] dark:text-[#F0F0F0]/90 mb-3 text-xs md:text-xl flex items-start gap-2 font-semibold">
            ...
            <p className="text-[#FFFFFF] dark:text-[#F0F0F0]/90 mb-4 md:mb-6 text-xs md:text-xl flex items-center gap-2 font-semibold">
          ...
          <div className="flex flex-col items-start w-[48%] md:w-full md:max-w-[280px]">
            ...
            <div className="flex flex-col gap-4 md:gap-5 w-full">
              ...
              <a href="https://www.instagram.com/hard_clean.vinnytsia/" target="_blank" rel="noreferrer" className="group flex items-center gap-2 md:gap-4 hover:-translate-y-1 transition-transform text-left">
                <div className="w-8 h-8 md:w-14 md:h-14 bg-white dark:bg-[#121212] text-[#FFC107] dark:text-[#E0A500] rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow shrink-0">
                ...
                <span className="font-black text-[11px] sm:text-xs md:text-xl text-[#FFFFFF] dark:text-[#F0F0F0]">@hard_clean.vinnytsia</span>
              </a>
      ...
      <div className="w-full flex flex-col md:flex-row justify-center items-center gap-2 md:gap-8 text-center text-[#FFFFFF] dark:text-[#F0F0F0]/60 text-sm mt-12 md:mt-16 pt-8 border-t border-white/20 max-w-7xl mx-auto px-6 font-semibold">
